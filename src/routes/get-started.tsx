...
import { Activity, Droplet, BedDouble, ShieldCheck, User, ArrowLeft } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <Card className="p-8 hover:shadow-lg transition-all hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-2">Bed Availability</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-8 hover:shadow-lg transition-all hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-2">Blood Inventory</h3>
              <p className="text-muted-foreground">
